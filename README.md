...
> Pod configuration for the homepage can be found in the [`/Homepage`](./Homepage) directory.
...
> Pod configuration for the homepage can be found in the [`/Nextcloud`](./Nextcloud) directory.
...
> Pod configuration for the homepage can be found in the [`/Wger`](./Wger) directory.
